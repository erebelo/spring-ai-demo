package com.erebelo.springaidemo;
...
class SpringAIDemoApplicationTest {
    ...
    void mainRunSuccessful() {
        try (MockedStatic<SpringApplication> mockedStatic = mockStatic(SpringApplication.class)) {
            ...
            SpringAIDemoApplication.main(new String[]{});

            mockedStatic.verify(() -> SpringApplication.run(SpringAIDemoApplication.class, new String[]{}));
        }
    }
}
